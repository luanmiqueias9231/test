...
INSERT INTO users
    (name,email,role_id,created_dt,password, is_active, is_email_verified)
VALUES('John Doe', 'admin@school-admin.com', 1, now(), '$argon2id$v=19$m=65536,t=3,p=4$yWco0ZxCI4LpG4bjf+P8Xg$WcXfEpoQ0bA3mLBv6yx17zhWSYLuqaBXV/GiFimEUMg', true, true)
RETURNING id;
